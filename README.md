...
* [@sean1983](https://github.com/sean1983) for detailed docu# PixMob IR Reverse Engineering
...
...get more details about the PixMob firmware operation and various mem# PixMob IR Reverse Engineering
...
ories: see [docs/operation.md](docs/operation.md)


mentation of PixMob's effects and helping me test effects on a wider variety of PixMob models
